...
const removeHeader = (res1, name)=>{
    res1.removeHeader(name);
    if ('_blitz' in res1) {
        delete res1._blitz[name];
    }
};
    ...
    _asyncToGenerator(function*(req1, res1) {
        ...
        if (sessionToken) {
            ...
            if (enableCsrfProtection && persistedSession.antiCSRFToken !== antiCSRFToken) {
                if (!antiCSRFToken) {
                    // log.warning(
                    console.log(`This request is missing the ${_constants.HEADER_CSRF} header. You can learn about adding this here: https://blitzjs.com/docs/session-management#manual-api-requests`);
                }
