...
function getProtocol(req) {
    ...
    const forwardedProto = req.headers && (((ref1 = (ref = req.headers['forwarded']) === null || ref === void 0 ? void 0 : ref.match(/(?<=proto=).+/g)) === null || ref1 === void 0 ? void 0 : ref1[0]) || req.headers['x-forwarded-proto']);
    if (forwardedProto) {
