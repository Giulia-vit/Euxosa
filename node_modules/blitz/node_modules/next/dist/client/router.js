...
function useRouterQuery() {
    ...
    const query = _react.default.useMemo(()=>{
        const query1 = (0, _router).extractQueryFromAsPath(router.asPath);
        return query1;
    }, [
        router.asPath
    ]);
        ...
        if (returnType === 'number') {
            ...
            for(const key in rawParams){
                if (rawParams[key]) {
                    ...
                    params1[key] = isNaN(num) ? undefined : num;
                }
            }
            return params1;
        }
