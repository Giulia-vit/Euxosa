...
class New extends command_2.Command {
    ...
    maybeUpgradeGloballyInstalledBlitz() {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            const spinner = display_1.log
                .spinner(display_1.log.withBrand("Checking if a new Blitz release is available"))
                .start();
            ...
            if ((0, semver_1.lt)(this.config.version, latestVersion)) {
                spinner.succeed(display_1.log.withBrand("A new Blitz release is available"));
                if (yield this.promptBlitzUpgrade(latestVersion)) {
                    ...
                    if (versionResult.stdout) {
                        ...
                        if (newVersion[0] && newVersion[0] === latestVersion) {
                            display_1.log.success(`Upgraded blitz global package to ${newVersion[0]}, running blitz new command...`);
                            return true;
                        }
                    }
                ...
                spinner.succeed(display_1.log.withBrand("You have the latest Blitz version"));
            }
            return false;
        });
    }
